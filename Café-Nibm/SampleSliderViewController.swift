...
//
//  SampleSliderViewController.swift
//  Café-Nibm
//
...
class SampleSliderViewController: UIViewController {
    ...
    extension SampleSliderViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    extension SampleSliderViewController: UICollectionViewDelegateFlowLayout {
